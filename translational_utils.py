...
PFNVR_HDELB_RAW = np.genfromtxt("connectivity_matrices/PFNVR_HDELB.csv", delimiter=',', dtype = 'float64')
PFNVL_HDELB_RAW = np.genfromtxt("connectivity_matrices/PFNVL_HDELB.csv", delimiter=',', dtype = 'float64')
PFNDR_HDELB_RAW = np.genfromtxt("connectivity_matrices/PFNDR_HDELB.csv", delimiter=',', dtype = 'float64')
PFNDL_HDELB_RAW = np.genfromtxt("connectivity_matrices/PFNDL_HDELB.csv", delimiter=',', dtype = 'float64')

EPGL_PFNDL = np.genfromtxt("connectivity_matrices/EPGL_PFNDL.csv", delimiter=',', dtype = 'float64')
EPGR_PFNDR = np.genfromtxt("connectivity_matrices/EPGR_PFNDR.csv", delimiter=',', dtype = 'float64')
EPGL_PFNVL = np.genfromtxt("connectivity_matrices/EPGL_PFNVL.csv", delimiter=',', dtype = 'float64')
EPGR_PFNVR = np.genfromtxt("connectivity_matrices/EPGR_PFNVR.csv", delimiter=',', dtype = 'float64')
...
def get_travel_direction(movement_info):
    ...
    # The relative travel angle is positive if xs is positive
    # and negative if xs is negative
    #return np.sign(vs)*fly_centric_angle
...
def make_fixed_allocentric_direction_inputs(allocentric_travel_dir, num_inputs,
    ...
    rot_mat = [[0.0, -1.0], [1.0, 0.0]] # Changed 20210518
